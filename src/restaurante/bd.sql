...
CREATE TABLE venta (
  ...
  id_estado_venta INT(11) DEFAULT NOT NULL,
  ...
  CONSTRAINT FK_estado_venta1 FOREIGN KEY (id_estado_venta) REFERENCES estado_mesa (id_estado_venta) ON DELETE NO ACTION ON UPDATE NO ACTION
